...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Ski Conditions Report CLI for LearnCo Ruby CLI Final Project.}
  spec.homepage      = "https://github.com/lukekyl/skireport"
  spec.license       = "MIT"
  ...
  spec.add_dependency "nokogiri", ">= 1.10.4", "< 1.15.0"
